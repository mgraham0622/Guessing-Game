...
4) Use C++ commands instead of C commands (<iostream> instead of studio, new instead of malloc, delete instead of free)
Secret 4th and 5th strongly worded reccomendations:
5) Avoid using a mouse when possible
6) Avoid using Break/Continue unless you have to (like in a switch statement).
